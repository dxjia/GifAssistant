...
public class TextPicker extends LinearLayout {
    ...
    /**
     * Use a custom TextPicker formatting callback to use two-digit minutes
     * strings like "01". Keeping a static formatter etc. is the most efficient
     * way to do this; it avoids creating temporary objects on every call to
     * format().
     */
    private static class TwoDigitFormatter implements TextPicker.Formatter {
    ...
    /**
     * Lower value of the range of numbers allowed for the TextPicker
     */
    private int mMinValue;

    /**
     * Upper value of the range of numbers allowed for the TextPicker
     */
    private int mMaxValue;

    /**
     * Current value of this TextPicker
     */
    private int mValue;
    ...
    public interface OnValueChangeListener {
         ...
         *
         * @param picker The TextPicker associated with this listener.
         * @param oldVal The previous value.
         * @param newVal The new value.
         */
        void onValueChange(TextPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(TextPicker view, int scrollState);
    }
     ...
     */
    public TextPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        ...
        // input text
        mInputText = (EditText) findViewById(R.id.np_textpicker_input);
     ...
     * <p>
     * If the argument is less than the {@link TextPicker#getMinValue()} and
     * {@link TextPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link TextPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link TextPicker#getMinValue()} and
     * {@link TextPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link TextPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link TextPicker#getMaxValue()} and
     * {@link TextPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link TextPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link TextPicker#getMinValue()} and
     * {@link TextPicker#getMaxValue()} values.
     * <p>
    ...
    /**
     * Sets the current value of this TextPicker.
     *
     * @param current The new value of the TextPicker.
    ...
    /**
     * Updates the view of this TextPicker. If displayValues were specified in
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                TextPicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (TextPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (TextPicker.this.isEnabled()) {
                                TextPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (TextPicker.this.isEnabled()) {
                                ...
                                TextPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(TextPicker.this, VIRTUAL_VIEW_ID_INPUT);
