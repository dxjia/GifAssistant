...
public class GifDecoder extends Thread{
	...
	private static final String TAG = AppConfigs.APP_TAG + "GifDecoder";
	...
	private boolean mJustParseOneFrameForCoverShow = false;
	...
	public GifDecoder(byte[] data,GifAction act, boolean showCover){
		gifData = data;
		action = act;
		mJustParseOneFrameForCoverShow = showCover;
	}
	
	public GifDecoder(InputStream is,GifAction act, boolean showCover){
		in = is;
		action = act;
		mJustParseOneFrameForCoverShow = showCover;
	}
	...
	private void readContents() {
		...
		while (!(done || err())) {
			...
			case 0x2C: // image separator
				...
				// just parse one image
				if (mJustParseOneFrameForCoverShow) {
					done = true;					
				}
				break;
			case 0x21: // extension
